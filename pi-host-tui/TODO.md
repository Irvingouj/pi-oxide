...
2. **grep/find/glob tools** — Cannot search codebases without them. Both `pi` (7 tools) and claude-code (~40 tools) include these. pi-oxide currently has 4 tools (bash/read/write/edit).
