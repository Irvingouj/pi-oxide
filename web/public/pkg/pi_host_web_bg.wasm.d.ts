...
export const onToolCancelled: (a: number, b: number, c: number, d: number, e: number) => [number, number];
export const onToolDone: (a: number, b: number, c: number, d: number, e: number) => [number, number];
export const onToolStarted: (a: number, b: number, c: number) => [number, number];
export const onToolUpdate: (a: number, b: number, c: number) => [number, number];
