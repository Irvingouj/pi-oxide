...
export const readFileSchema: object = {
	...
	properties: {
		path: {
			type: "string",
			description:
				'Workspace-root-relative path of the file to read (e.g. "src/main.rs").',
		},
	},
	required: ["path"],
...
export const searchFilesSchema: object = {
	...
	properties: {
		pattern: {
			type: "string",
			description:
				'Search pattern. Matches against file paths (e.g. "*.rs", "test_").',
		},
		path: {
			type: "string",
			description:
...
export const writeFileSchema: object = {
	...
	properties: {
		path: {
			type: "string",
			description:
				'Workspace-root-relative path of the file to write (e.g. "src/main.rs").',
		},
		content: {
			type: "string",
...
export const readToolSchema: object = {
	...
	properties: {
		path: {
			type: "string",
			description:
				'Workspace-root-relative path of the file to read (e.g. "src/main.ts").',
		},
		offset: {
			type: "number",
			description:
...
export const editToolSchema: object = {
	...
	properties: {
		...
		edits: {
			...
			description:
				"Array of exact-find-and-replace edits to apply sequentially.",
		},
	},
	required: ["path", "edits"],
	additionalProperties: false,
...
export const grepToolSchema: object = {
	...
	properties: {
		pattern: {
			type: "string",
			description:
				"Search pattern (regex by default, or literal if literal is true).",
		},
		path: {
			type: "string",
			description:
		...
		glob: {
			type: "string",
			description:
				'File glob to filter (e.g. "*.ts"). Only matching files are searched.',
		},
		ignoreCase: {
			type: "boolean",
		...
		literal: {
			type: "boolean",
			description:
				"If true, treat pattern as a literal string instead of regex.",
		},
		context: {
			type: "number",
...
export const findToolSchema: object = {
	...
	properties: {
		pattern: {
			type: "string",
			description:
				'Glob-like pattern to match against file paths (e.g. "*.ts", "src/**/*.rs").',
		},
		path: {
			type: "string",
			description:
				"Workspace-root-relative directory to search in. Omit to search from root.",
		},
		limit: {
			type: "number",
...
export const bashToolSchema: object = {
	...
	properties: {
		command: {
			type: "string",
			description:
				"Command to execute. Only a small whitelist of test commands is supported.",
		},
	},
	required: ["command"],
	additionalProperties: false,
...
export const PI_CODING_TOOLS: ToolDefinition[] = [
	READ_TOOL,
	BASH_TOOL,
	EDIT_TOOL,
	WRITE_TOOL,
...
export const PI_READ_ONLY_TOOLS: ToolDefinition[] = [
	READ_TOOL,
	GREP_TOOL,
	FIND_TOOL,
	LS_TOOL,
